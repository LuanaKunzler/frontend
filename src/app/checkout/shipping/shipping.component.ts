...
export class ShippingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.shippingForm = new FormGroup({
      shipAddress: new FormControl(null, [Validators.required, BlankValidators.notBlankValidator, Validators.minLength(3), Validators.maxLength(240)]),
      billingAddress: new FormControl(null, [BlankValidators.checkIfBlankValidator, Validators.minLength(3), Validators.maxLength(240)]),
      city: new FormControl(null, [Validators.required, BlankValidators.notBlankValidator, Validators.minLength(3), Validators.maxLength(100)]),
      state: new FormControl(null, [BlankValidators.checkIfBlankValidator, Validators.minLength(2), Validators.maxLength(40)]),
      zip: new FormControl(null, [Validators.required, Validators.maxLength(9), Validators.minLength(5)]),
      country: new FormControl(null, [Validators.required, BlankValidators.notBlankValidator, Validators.minLength(2), Validators.maxLength(40)])
    });
